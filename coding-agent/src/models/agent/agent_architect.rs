...
use crate::models::agent_basics::basic_agent::{AgentState,BasicAgent};
use crate::models::agent::agent_traits::{FactSheet, SpecialFunctions};
use crate::models::agent_basics::basic_traits::BasicTrait;
use crate::utils::general::{ai_task_request,check_status_code,ai_task_request_decoed}; 
use crate::utils::command_line_utils::printCommand;
use crate::ai_function::ai_fun_architech::{print_project_scope, print_site_urls};

use async_trait::async_trait;
use reqwest::Client;
use std::time::Duration;

use super::agent_traits::ProjectScope;
...
impl AgentSolutionArchitect {
    ...
    async fn call_project_scope(&mut self, factsheet: &mut FactSheet) -> ProjectScope {
        ...
        let ai_response: ProjectScope = ai_task_request_decoed::<ProjectScope>(
            msg_context,
    ...
    async fn call_determine_external_urls(
        ...
        let ai_response: Vec<String> = ai_task_request_decoed::<Vec<String>>(
            msg_context,
            &self.attributes.position,
